...
#     ) -> list[Question]:
#         if theme_id:
#             questions = [question for question in self.app.database.questions if question.theme_id == theme_id]
#         else:
#             questions = [question for question in self.app.database.questions]
#
#         return questions
